...
def make_mfcc(file_name):import librosa
import numpy as np
import matplotlib.pyplot as plt
import librosa.display
...
fig, ax = plt.subplots(nrows=4, ncols=1, sharex=True, figsize=(8, 9))
data1 = make_stft('C:/Users/user/PycharmProjects/PNP/processed_dataset/train/1728-00.wav')
data2 = make_mel('C:/Users/user/PycharmProjects/PNP/processed_dataset/train/1728-00.wav')
data3 = make_cqt('C:/Users/user/PycharmProjects/PNP/processed_dataset/train/1728-00.wav')
data4 = make_mfcc('C:/Users/user/PycharmProjects/PNP/processed_dataset/train/1728-00.wav')
img1 = librosa.display.specshow(data1, hop_length=hop_length, x_axis='time', y_axis='log', ax=ax[0])
ax[0].set(title='STFT (log scale)')
img2 = librosa.display.specshow(data2, hop_length=hop_length, x_axis='time', y_axis='mel', ax=ax[1])
ax[1].set(title='Mel-Spectrogram')
